...
#include <iostream>
#include <cstdint>
enum __ExpectedDataType{UNKNOWN,INT8,INT16,INT32,INT64,UINT8,UINT16,UINT32,UINT64,FLOAT,CSTRING,CUSTOM};
class DataRefStructure
{
public:
    DataRefStructure(size_t mDataOffset, byte* m_dataPtr, __ExpectedDataType dataType=UNKNOWN, size_t dataSize=-1);
    ~DataRefStructure();
